          ...
          <nav className="flex flex-wrap items-center gap-14">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-3 h-full ">
                <Link
                  to={"/login"}
                  className="font-thin hover:font-normal hover:text-gray-900 border-transparent hover:border-b-4 hover:border-b-fuchsia-600 transition-all duration-300 ease-in-out bg-[rgb(206,225,122)] hover:bg-[rgb(189,201,134)] text-black hover:scale-110  px-4 py-2 h-full flex items-center"
                >
                  SIGN IN
                </Link>
                <Link
